...
The number of HDUs in a file can be queried with the [`num_hdus`][fits-file-num-hdus] method:
```rust
use fitsio::FitsFile;
...
[fits-file-num-hdus]: fitsfile/struct.FitsFile.html#method.num_hdus
...
#![doc(html_root_url = "https://docs.rs/fitsio/0.21.8")]
#![deny(missing_docs)]
